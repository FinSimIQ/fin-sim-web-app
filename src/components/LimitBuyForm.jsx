...
const LimitBuyForm = ({ stockData, portfolioData, onSubmit }) => {
  ...
  const handleBuy = () => {
    if (validateInput()) {
      ...
      toast({
        ...
        description: `You are attempting to buy ${shares} shares at a limit price of $${limitPrice}`,
        status: "success",
        duration: 5000,
        isClosable: true,
      });
